...
/**
 * The Gemini model name to be used for ad copy analysis.
 * 'gemini-3-pro-preview' is chosen for its enhanced reasoning capabilities.
 */
export const GEMINI_MODEL = 'gemini-3-pro-preview';

/**
 * The fixed disclaimer required at the end of all analysis results.
 */
export const FIXED_DISCLAIMER = '본 결과는 법률 자문이 아닌 일반적인 안전 가이드입니다.';

/**
 * Defines the strict JSON schema expected from the Gemini API for the ad analysis result.
 * This guides the AI to produce consistent and parseable output.
 */
export const GEMINI_RESPONSE_SCHEMA: GeminiResponseSchema = {
  type: Type.OBJECT,
  properties: {
    summary: {
      type: Type.OBJECT,
